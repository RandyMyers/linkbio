...
function serializeMailchimpSettings(mc = {}) {
  return {
    ...
    autoSyncSignups: !!mc.autoSyncSignups,
    autoSyncSubscribers: !!mc.autoSyncSubscribers,
    autoSyncPaidSubscribers: !!mc.autoSyncPaidSubscribers,
    cachedListStats: mc.cachedListStats || null,
  };
}
